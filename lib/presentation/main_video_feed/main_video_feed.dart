...
class _MainVideoFeedState extends State<MainVideoFeed>
  ...
  Future<void> _loadVideos() async {
    try {
      ...
      if (videos.isEmpty && !AuthService.instance.isAuthenticated) {
        setState(() {
          _isLoading = false;
        });
        return;
  ...
  List<Content> _getPreviewContent() {
    ...
    return [
      ...
      Content(
          ...
          creatorId: 'creator1',
          type: ContentType.video,
          description: 'Amazing dance video! #trending #dance',
          videoUrl:
      ...
      Content(
          ...
          creatorId: 'creator2',
          type: ContentType.video,
          description: 'Funny cat compilation 😸 #cats #funny',
          videoUrl:
      ...
      Content(
          ...
          creatorId: 'creator3',
          type: ContentType.video,
          description: 'Delicious recipe tutorial 🍕 #cooking #recipe',
          videoUrl:
              'https://flutter.github.io/assets-for-api-docs/assets/videos/bee.mp4',
          tags: ['cooking', 'recipe'],
          allowsComments: true,
  ...
  Widget _buildLoadingState() {
    return Container(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          SizedBox(height: 1.h),
          Text('Get ready for the best videos!',
            ...
            children: [
              ...
              Container(
                  ...
                  child: Icon(Icons.video_library_outlined,
                      size: 80.sp, color: Color(0xFFFF6B35))),
              SizedBox(height: 3.h),
              Text(
              ...
              if (!AuthService.instance.isAuthenticated) ...[
                ...
                OutlinedButton.icon(
                    onPressed: () {
                      Navigator.pushNamed(
                          context, AppRoutes.videoCreationStudio);
                    },
        ...
        builder: (context) => Container(
            ...
            child: Column(children: [
              ...
              if (video.allowsDuets == true)
                ListTile(
                    leading: Icon(Icons.duo_outlined,
                        color: Colors.white, size: 24.sp),
                    title: Text('Duet',
                        style: TextStyle(color: Colors.white, fontSize: 16.sp)),
                    onTap: () {
  ...
  void _viewProfile(String creatorId) {
    if (creatorId.isNotEmpty) {
      Navigator.pushNamed(context, AppRoutes.userProfile, arguments: creatorId);
    }
  }
  ...
  Future<void> _handleLike(String contentId) async {
    ...
    try {
      ...
      setState(() {
        ...
        if (index != -1) {
          _videos[index] =
              _videos[index].copyWith(likeCount: _videos[index].likeCount + 1);
        }
      });
    } catch (e) {
      if (mounted) {
              ...
              child: Column(
                ...
                Row(children: [
                  ...
                  if (comment.user?.verified == true) ...[
                    SizedBox(width: 1.w),
                    Icon(Icons.verified, color: Color(0xFFFF6B35), size: 16.sp),
                  ],
                  Spacer(),
    ...
    showDialog(
        ...
        builder: (context) => AlertDialog(
                ...
                content: Text(
                    ...
                    style: TextStyle(
                        color: Colors.white70, fontSize: 14.sp, height: 1.4)),
                actions: [
                  TextButton(
                      onPressed: () => Navigator.pop(context),
                      child: Text('Cancel',
